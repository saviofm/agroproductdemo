		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#agroproductdemoappmatrix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"agroproductdemoappmatrix-display": {
								"semanticObject": "agroproductdemoappmatrix",
								"action": "display",
								"description": "Product Substitution Matrix",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=agroproductdemo.app.matrix",
									"url": sap.ui.require.toUrl("agroproductdemo/app/matrix")
								}
							}
						}
					}
